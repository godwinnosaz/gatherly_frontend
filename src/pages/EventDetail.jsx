        ...
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                ...
                <div className="flex items-center gap-3 w-full md:w-auto">
                    <button className="flex-1 md:flex-none p-4 md:p-3 bg-white text-slate-600 hover:text-primary rounded-2xl border border-slate-200 shadow-sm transition-all flex items-center justify-center gap-2">
                        <Share2 size={18} />
                        <span className="md:hidden font-bold text-sm">Share</span>
                    </button>
                    <button className="flex-1 md:flex-none p-4 md:p-3 bg-white text-slate-600 hover:text-secondary rounded-2xl border border-slate-200 shadow-sm transition-all flex items-center justify-center gap-2">
                        <Edit size={18} />
                        <span className="md:hidden font-bold text-sm">Edit</span>
                    </button>
                    <button className="flex-1 md:flex-none p-4 md:p-3 bg-red-50 text-red-600 hover:bg-red-100 rounded-2xl border border-red-100 transition-all flex items-center justify-center gap-2">
                        <Trash2 size={18} />
                            ...
                            {attendees.length > 0 ? attendees.map((attendee, idx) => (
                                <div key={idx} className="flex items-center gap-4 p-4 hover:bg-slate-50 rounded-2xl transition-all border border-transparent hover:border-slate-100 group">
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <p className="text-sm font-black text-slate-900 truncate">{attendee.first_name} {attendee.last_name}</p>
                                        <p className="text-[10px] text-slate-400 uppercase font-black tracking-widest mt-0.5">{attendee.status.replace('_', ' ')}</p>
                                    </div>
