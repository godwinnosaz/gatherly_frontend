...
const MemberDashboard = () => {
    ...
    const actions = [
        { label: 'Basic Profile', icon: Sparkles, onClick: () => navigate('/dashboard/profile') },
        { label: 'Events', icon: Calendar, onClick: () => navigate('/dashboard/events') },
        { label: 'Attendance', icon: Heart, onClick: () => navigate('/dashboard/events') },
    ];
