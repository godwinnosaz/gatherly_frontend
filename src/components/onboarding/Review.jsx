...
const Review = ({ onNext, onBack, formData }) => {
    const summaryItems = [
        ...
        { label: 'Departments', value: `${formData.departments?.length || 0} configured` },
        { label: 'Initial Members', value: `${formData.memberCount || 0} imported` },
        { label: 'First Events', value: `${formData.events?.length || 0} scheduled` },
        { label: 'Tracking Method', value: formData.attendanceMethod?.toUpperCase() || 'QR' }
    ];
        ...
        <div className="space-y-8">
            <div className="text-center space-y-4">
                ...
                <p className="text-slate-500 font-medium max-w-md mx-auto leading-relaxed">
                    Review your configuration below. Once you click "Initialize Dashboard", your system will be fully operational.
                </p>
            </div>
            ...
            <div className="p-10 rounded-[2.5rem] bg-primary text-white relative overflow-hidden group shadow-2xl shadow-blue-900/20">
                <div className="relative z-10">
                    <h3 className="text-2xl font-black tracking-tight uppercase">Initialize Ecosystem</h3>
                    <p className="text-blue-100 text-sm mt-2 max-w-xs font-medium leading-relaxed">
                        Welcome to the future of ministry administration. Your system is ready for deployment.
                    </p>
                    <button 
                        onClick={() => onNext({})}
