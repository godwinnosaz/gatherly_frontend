        ...
        <div className="space-y-8">
            <div className="space-y-4">
                ...
                <p className="text-lg text-slate-600 leading-relaxed max-w-2xl">
                    We're excited to help you streamline your ministry operations. This quick setup will guide you through configuring your organization, members, and events.
                </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-4 py-4">
                <div className="p-5 rounded-2xl border border-slate-100 bg-white shadow-sm flex gap-4">
                    ...
                    <div>
                        <h4 className="font-semibold text-slate-900">~5 mins setup</h4>
